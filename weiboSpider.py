...
class weibo:
	cookie = {"Cookie": "SCF=Au53NBtftXzIR-b01h3x_yE4_oBIC1cTThK0Xt817ZxaLEE5uHQbn7GOSGFhvrFneozN7Qd_PpXS4ph5RF8Pw1E.; _T_WM=0993c71bc8627e8f1c71999ecd850d8e; SUB=_2A250MsANDeThGeBM71UQ-CjKyjSIHXVX3OBFrDV6PUJbkdBeLRLnkW00Xb5KFa40KQiGFgGeArejM8ufSg..; SUHB=0HTx9_E8nD1jBB; SSOLoginState=1496756317"} #将your cookie替换成自己的cookie
	#weibo类初始化
	def __init__(self,user_id,filter = 0):
			self.user_id = 1003061549362863#用户id，即需要我们输入的数字，如昵称为“Dear-迪丽热巴”的id为1669879400
			self.filter = 1 #取值范围为0、1，程序默认值为0，代表要爬取用户的全部微博，1代表只爬取用户的原创微博
			self.userName = '张大奕eve' #用户名，如“Dear-迪丽热巴”
